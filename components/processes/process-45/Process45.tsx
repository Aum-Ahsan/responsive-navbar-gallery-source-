...
export default function Process45() {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto p-8 font-sans bg-slate-900 text-white rounded-3xl my-10 border-[4px] border-indigo-900 shadow-[0_0_50px_rgba(79,70,229,0.3)]">
