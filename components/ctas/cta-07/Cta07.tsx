  ...
  return (
    <div className="w-full w-full p-4 sm:p-8 my-10 font-sans">
      <div className="bg-black text-white rounded-[2rem] p-8 sm:p-16 relative overflow-hidden border border-gray-800 shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl sm:text-5xl font-black mb-6 leading-tight tracking-tight">
          ...
          <div className="w-full sm:w-auto bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-md text-center flex flex-col items-center">
            ...
            <div className="flex items-center justify-center gap-2 mb-2">
              <div className="text-3xl sm:text-5xl lg:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-b from-white to-gray-500 tabular-nums tracking-tighter">
