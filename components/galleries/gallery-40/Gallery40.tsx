...
export default function Gallery40() {
  const floaters = [
    ...
    { src: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e', top: '15%', left: '45%', size: 'w-56 h-64 md:w-80 md:h-96', delay: 'delay-100' },
  ...
  return (
    <div className="w-full h-[800px] bg-slate-900 font-sans relative overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-20">
        <h2 className="text-[10vw] font-black text-white/50 uppercase tracking-tighter drop-shadow-2xl">Floating</h2>
      </div>
