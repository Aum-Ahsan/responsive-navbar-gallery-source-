...
export default function Cta12() {
  return (
    <div className="w-full w-full p-4 sm:p-8 my-10 font-sans">
      <div className="bg-[#f0f0ed] rounded-[1.5rem] sm:rounded-[2rem] lg:rounded-[3rem] p-8 sm:p-16 lg:p-24 flex flex-col items-center text-center">
        
        <h2 className="text-3xl sm:text-4xl lg:text-5xl sm:text-7xl lg:text-8xl font-black tracking-tighter text-[#151515] mb-8 leading-[0.9]">
          READY TO <br /> <span className="text-[#a0a09b]">DEPLOY?</span>
        </h2>
        
        <p className="text-[#5c5c57] text-xl sm:text-2xl font-medium max-w-2xl mb-8 sm:mb-12 lg:mb-16 tracking-tight">
          Join the fastest growing network of edge developers. Ship your next project in milliseconds.
        </p>

        <a 
          href="#deploy" 
          className="group relative inline-flex items-center justify-center px-4 sm:px-8 lg:px-12 py-6 bg-[#151515] text-white rounded-full overflow-hidden transition-transform hover:scale-105 active:scale-95"
        >
