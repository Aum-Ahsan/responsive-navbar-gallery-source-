  ...
  return (
    <div className="w-full max-w-3xl mx-auto p-8 font-sans">
      ...
      <div className="flex flex-col items-center">
        {/* Node 1 */}
        <div className="bg-stone-800 text-white px-4 md:px-8 py-3 rounded-full text-sm md:text-base font-bold shadow-md text-center">User Requests Access</div>
        
        <ArrowDown className="text-stone-300 my-2" />

        {/* Decision Node */}
        <div className="bg-amber-100 border-2 border-amber-300 text-amber-900 px-4 md:px-8 py-4 md:py-6 rounded-lg text-sm md:text-base font-bold shadow-sm rotate-3 transform relative text-center">
          Has valid JWT token?
        </div>

        <div className="flex w-full max-w-md justify-between px-8 md:px-12 -mt-4">
          <div className="flex flex-col items-center">
        ...
        <div className="flex w-full max-w-lg justify-between mt-0">
          {/* Yes Branch */}
          <div className="bg-emerald-100 border border-emerald-300 text-emerald-800 px-2 md:px-6 py-4 rounded-xl text-center w-36 md:w-48 shadow-sm">
            <h4 className="font-bold">Grant Access</h4>
            <p className="text-xs mt-1">Load Dashboard UI</p>
          </div>

          {/* No Branch */}
          <div className="bg-rose-100 border border-rose-300 text-rose-800 px-2 md:px-6 py-4 rounded-xl text-center w-36 md:w-48 shadow-sm">
