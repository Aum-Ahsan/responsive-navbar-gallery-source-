        ...
        <div className="md:w-1/2 p-8 sm:p-10 flex flex-col justify-between">
          <div>
            ...
            {method === "card" ? (
              ...
              <div className="space-y-4">
                <button className="w-full py-4 rounded-xl border border-slate-200 bg-slate-50 hover:bg-slate-100 transition font-bold text-slate-700 flex justify-center items-center gap-2">
          ...
          <div className="mt-8">
            ...
            <button className="w-full py-3 mt-3 rounded-xl font-medium text-sm text-slate-500 hover:text-slate-800 transition flex items-center justify-center gap-2">
