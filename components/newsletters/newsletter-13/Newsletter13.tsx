...
export default function Newsletter13() {
    ...
    <div className="w-full p-4 sm:p-8 my-10 font-sans">
      <div className="bg-[#f0f0f0] border-4 border-black p-5 sm:p-8 md:p-12 shadow-[12px_12px_0_0_rgba(0,0,0,1)] flex flex-col sm:flex-row gap-8 items-center">
        <div className="flex-1 text-center lg:text-left">
          ...
          <p className="text-xl font-bold border-l-4 border-teal-600 pl-4 text-black">NO SPAM. JUST PURE VALUE.</p>
        </div>
        <div className="w-full lg:w-1/2">
          {status === 'success' ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <button type="submit" disabled={status==='loading'} className="w-full py-5 bg-teal-600 hover:bg-black border-4 border-black text-white text-2xl font-black uppercase transition-colors shadow-[6px_6px_0_0_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 hover:shadow-[2px_2px_0_0_rgba(0,0,0,1)]">
