...
export default function Process39() {
  ...
  return (
    <div className="w-full w-full p-4 sm:p-8 font-sans my-10 overflow-hidden">
      ...
      <div className="flex overflow-x-auto gap-6 pb-12 snap-x snap-mandatory px-4 hide-scrollbar" style={{ scrollbarWidth: 'none' }}>
        {steps.map((step) => (
          <div key={step.id} className="snap-center shrink-0 w-72 md:w-96 h-96 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-[1.25rem] sm:rounded-[2rem] lg:rounded-[2.5rem] p-5 sm:p-8 lg:p-10 flex flex-col justify-end relative shadow-2xl">
