...
export default function Process32() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto font-sans bg-white border border-gray-200 rounded-[2rem] overflow-hidden my-10 shadow-sm flex flex-col md:flex-row min-h-[400px] lg:min-h-[500px]">
