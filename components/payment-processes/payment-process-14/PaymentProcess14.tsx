          ...
          <div className="p-6 sm:p-8 md:p-12 bg-white">
            ...
            <form onSubmit={handlePay} className="space-y-4 sm:space-y-6">
              ...
              <div>
                ...
                <input required type="text" placeholder="John Doe" className="w-full bg-white border border-gray-300 rounded-xl px-4 py-3 focus:outline-none text-sm sm:text-base focus:ring-lime-500/20 focus:border-lime-500" />
              </div>
              <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input maxLength={3} onInput={(e) => { e.currentTarget.value = e.currentTarget.value.replace(/\D/g, '').substring(0, 3); }} required type="text" placeholder="123" className="w-full bg-white border border-gray-300 rounded-xl px-4 py-3 focus:outline-none font-mono text-sm sm:text-base focus:ring-lime-500/20 focus:border-lime-500" />
                </div>
              </div>
