          ...
          <div className="p-6 sm:p-8 md:p-12 bg-white">
            ...
            <form onSubmit={handlePay} className="space-y-4 sm:space-y-6">
              ...
              <div>
                ...
                <input required type="text" placeholder="John Doe" className="w-full bg-white border border-gray-300 rounded-xl px-4 py-3 focus:outline-none text-sm sm:text-base focus:ring-indigo-600/20 focus:border-indigo-600" />
              </div>
              <div>
