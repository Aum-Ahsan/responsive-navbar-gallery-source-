    ...
    <div className="w-full h-[600px] md:h-[800px] bg-black font-sans flex flex-col mx-auto my-12 rounded-[2rem] overflow-hidden">
      {rows.map((row) => (
        ...
        >
          ...
          <div className="absolute inset-x-0 bottom-8 px-8 md:px-16 flex justify-between items-end opacity-0 translate-y-8 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-700 delay-100">
            ...
            <button className="flex items-center gap-2 text-white font-bold uppercase tracking-widest text-sm hover:gap-4 transition-all">
